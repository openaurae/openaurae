...
export class Database {
    ...
    public readonly nemoMeasureSets: ModelMapper<NemoMeasureSet>;
    ...
    constructor(host: string, keyspace: string) {
        ...
        this.mapper = new cassandra.mapping.Mapper(this.client, {
            models: {
                ...
                NemoMeasureSet: {tables: ["nemo_measure_set"]},
            },
        });
        ...
        this.nemoMeasureSets = this.mapper.forModel("NemoMeasureSet");
    }
    ...
    public async getNemoDeviceMeasureSet(deviceSerial: string, measureSetBid: number): Promise<NemoMeasureSet | null> {
        return this.nemoMeasureSets.get({
            device_serial: deviceSerial,
            bid: measureSetBid,
        })
    }

    public async upsertNemoDeviceMeasureSet(measureSet: NemoMeasureSet): Promise<void> {
        await this.nemoMeasureSets.insert(measureSet);
    }
