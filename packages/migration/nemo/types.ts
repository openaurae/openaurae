...
export const NemoMetricNameSchema = z.enum([
	"Battery",
	"Formaldehyde",
	"Temperature",
	"Humidity",
...
export type NemoMetricName = z.infer<typeof NemoMetricNameSchema>;

export const metricNameMapping: Record<NemoMetricName, keyof NemoMetrics> = {
	Battery: "battery",
	Formaldehyde: "ch2o",
...
export type NemoDeviceMeasureSets = {
